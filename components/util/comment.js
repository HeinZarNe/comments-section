...
export default function Comment() {
  return (
    <div className="w-100 row comment p-4">
      ...
      <div className="col-11 ps-3">
        <div className="d-flex justify-content-between">
          ...
          <div className="rp-btn">
            <IconContext.Provider
              value={{ className: "rp-icon me-1", size: 15 }}
            >
              <FaReply /> Reply
            </IconContext.Provider>
          </div>
        ...
        <div className="pt-2 comment-text ">
          Lorem ipsumsdafsdffdjjfiru juirhjguiiiiiiiiiiii iii iiiiiiiiiiiiiiiiii
          iiiiiiiiiiii iiiiis8rrrrrrrrrrrri opk
        </div>
      </div>
    </div>
  );
